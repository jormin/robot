				...
				<form id="setting-form">
					<div class="weui-cells weui-cells_form">
						...
						<div class="weui-cell">
							...
							<div class="weui-cell__bd">
								<input class="weui-inputt setting-select" name="speed" id="speed" type="text" value="5" readonly data-values="5">
							</div>
						</div>
						...
						<div class="weui-cell">
							...
							<div class="weui-cell__bd">
								<input class="weui-inputt setting-select" name="pitch" id="pitch" type="text" value="5" readonly data-values="5">
							</div>
						</div>
						<div class="weui-cell">
							<div class="weui-cell__hd"><label for="volume" class="weui-label">音量</label></div>
							<div class="weui-cell__bd">
								<input class="weui-inputt setting-select" name="volume" id="volume" type="text" value="5" readonly data-values="5">
							</div>
						</div>
					</div>
				</form>
