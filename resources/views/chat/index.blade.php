					...
					<div class="weui-cells weui-cells_form">
						...
						<div class="weui-cell">
							...
							<div class="weui-cell__bd">
								<input class="weui-input setting-select" name="person" id="person" type="text" value="女声" readonly="" data-values="0" unselectable="on">
							</div>
						</div>
						...
						<div class="weui-cell">
							...
							<div class="weui-cell__bd">
								<input class="weui-input setting-select" name="speed" id="speed" type="text" value="5" readonly="" data-values="5" unselectable="on">
							</div>
						</div>
						...
						<div class="weui-cell">
							...
							<div class="weui-cell__bd">
								<input class="weui-input setting-select" name="pitch" id="pitch" type="text" value="5" readonly="" data-values="5" unselectable="on">
							</div>
						</div>
						<div class="weui-cell">
							<div class="weui-cell__hd"><label for="volume" class="weui-label">音量</label></div>
							<div class="weui-cell__bd">
								<input class="weui-input setting-select" name="volume" id="volume" type="text" value="5" readonly="" data-values="5" unselectable="on">
							</div>
						</div>
					</div>
				</form>
